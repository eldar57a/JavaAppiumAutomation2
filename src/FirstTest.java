...
public class FirstTest extends CoreTestCase {
    ...
    @Test // Проверка поиска и закртыия экрана поиска
    ...
    @Test // Проверка свайпа вверх, пролистывает до конца
    ...
    @Test //Этот тест добавляет статью JAVA в закладки и затем ее оттуда удаляет
    public void saveFirstArticleToMyList()
    {
        ...
        waitForElementAndClick(
                ...
                "Cannot find 'Learning programming' input",
                5
        );
    ...
    @Test // Этот тест проверяет сколько элементов отображается в списке доступных поиску
    ...
    @Test //Тест проверки что по невалидному поиску нет выдачи ответов
    ...
    @Test // Тест ухода приложения в бэкраунд
    public void testCheckSearchArticleInBackground()
    {
        ...
        waitForElementPresent(
                By.xpath("//*[@resource-id='org.wikipedia:id/page_list_item_container']//*[@text='Object-oriented programming language']"),
                "Cannot find article auto returning from background",
                5
        );
    }
