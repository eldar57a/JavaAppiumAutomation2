...
public class TwoTest1 {
    ...
    @Test
    public void threeMethodEx3TestCancelSearching()
    {
        ...
        WebElement search_results_element = waitForElementPresent(
                By.id("org.wikipedia:id/page_list_item_title"),
                "Cannot find search results",
                15
        );

        String article_title = search_results_element.getAttribute("name");
        ...
        waitForElementNotPresent(
                By.id("org.wikipedia:id/page_list_item_title"),
                "Cannot find page list item is still to back input",
                5
        );
